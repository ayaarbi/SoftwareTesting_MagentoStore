...
WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_First Name_firstname'), '6')

WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Last Name_lastname'), 's')

WebUI.setText(findTestObject('Object Repository/Page_Create New Customer Account/input_Email_email'), 's@7.tt')
...
WebUI.verifyTextNotPresent('Thank you for registering with Main Website Store.', false, FailureHandling.CONTINUE_ON_FAILURE)
